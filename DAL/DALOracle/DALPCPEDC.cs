...
namespace DAL
{
    ...
    public class DALPCPEDC
    {
        ...
        public DALPCPEDC(DALTABConexao cx)
        {
            this.conexao = cx;
        }
        ...
        public void Incluir(ModeloPCPEDC modelo)
        {
            ...
            if (modelo.codusur != null) { cmd.Parameters.Add(new OracleParameter(":CODUSUR", modelo.codusur));}
            if (modelo.codcli != null) { cmd.Parameters.Add(new OracleParameter(":CODCLI", modelo.codcli));}
            if (modelo.numitens != null) { cmd.Parameters.Add(new OracleParameter(":NUMITENS", modelo.numitens));}
            if (modelo.vlatend != null) { cmd.Parameters.Add(new OracleParameter(":VLATEND", modelo.vlatend));}
            if (modelo.codpraca != null) { cmd.Parameters.Add(new OracleParameter(":CODPRACA", modelo.codpraca));}
            if (modelo.posicao != null) { cmd.Parameters.Add(new OracleParameter(":POSICAO", modelo.posicao));}
            if (modelo.numcar != null) { cmd.Parameters.Add(new OracleParameter(":NUMCAR", modelo.numcar));}
            if (modelo.codsupervisor != null) { cmd.Parameters.Add(new OracleParameter(":CODSUPERVISOR", modelo.codsupervisor));}
            if (modelo.codfilial != null) { cmd.Parameters.Add(new OracleParameter(":CODFILIAL", modelo.codfilial));}
            if (modelo.vltotal != null) { cmd.Parameters.Add(new OracleParameter(":VLTOTAL", modelo.vltotal));}
            if (modelo.vltabela != null) { cmd.Parameters.Add(new OracleParameter(":VLTABELA", modelo.vltabela));}
            if (modelo.vlcustoreal != null) { cmd.Parameters.Add(new OracleParameter(":VLCUSTOREAL", modelo.vlcustoreal));}
            if (modelo.vlcustofin != null) { cmd.Parameters.Add(new OracleParameter(":VLCUSTOFIN", modelo.vlcustofin));}
            if (modelo.totpeso != null) { cmd.Parameters.Add(new OracleParameter(":TOTPESO", modelo.totpeso));}
            if (modelo.totvolume != null) { cmd.Parameters.Add(new OracleParameter(":TOTVOLUME", modelo.totvolume));}
            if (modelo.codemitente != null) { cmd.Parameters.Add(new OracleParameter(":CODEMITENTE", modelo.codemitente));}
            if (modelo.operacao != null) { cmd.Parameters.Add(new OracleParameter(":OPERACAO", modelo.operacao));}
            if (modelo.tipovenda != null) { cmd.Parameters.Add(new OracleParameter(":TIPOVENDA", modelo.tipovenda));}
            if (modelo.obs != null) { cmd.Parameters.Add(new OracleParameter(":OBS", modelo.obs));}
            if (modelo.codcob != null) { cmd.Parameters.Add(new OracleParameter(":CODCOB", modelo.codcob));}
            if (modelo.hora != null) { cmd.Parameters.Add(new OracleParameter(":HORA", modelo.hora));}
            if (modelo.minuto != null) { cmd.Parameters.Add(new OracleParameter(":MINUTO", modelo.minuto));}
            if (modelo.codplpag != null) { cmd.Parameters.Add(new OracleParameter(":CODPLPAG", modelo.codplpag));}
            if (modelo.numpedcli != null) { cmd.Parameters.Add(new OracleParameter(":NUMPEDCLI", modelo.numpedcli));}
            if (modelo.percvenda != null) { cmd.Parameters.Add(new OracleParameter(":PERCVENDA", modelo.percvenda));}
            if (modelo.perdesc != null) { cmd.Parameters.Add(new OracleParameter(":PERDESC", modelo.perdesc));}
            if (modelo.vldesconto != null) { cmd.Parameters.Add(new OracleParameter(":VLDESCONTO", modelo.vldesconto));}
            if (modelo.vlfrete != null) { cmd.Parameters.Add(new OracleParameter(":VLFRETE", modelo.vlfrete));}
            if (modelo.vloutrasdesp != null) { cmd.Parameters.Add(new OracleParameter(":VLOUTRASDESP", modelo.vloutrasdesp));}
            if (modelo.obs1 != null) { cmd.Parameters.Add(new OracleParameter(":OBS1", modelo.obs1));}
            if (modelo.obs2 != null) { cmd.Parameters.Add(new OracleParameter(":OBS2", modelo.obs2));}
            if (modelo.condvenda != null) { cmd.Parameters.Add(new OracleParameter(":CONDVENDA", modelo.condvenda));}
            if (modelo.dtentrega != null) { cmd.Parameters.Add(new OracleParameter(":DTENTREGA", modelo.dtentrega));}
            if (modelo.numpedrca != null) { cmd.Parameters.Add(new OracleParameter(":NUMPEDRCA", modelo.numpedrca));}
            if (modelo.fretedespacho != null) { cmd.Parameters.Add(new OracleParameter(":FRETEDESPACHO", modelo.fretedespacho));}
            if (modelo.freteredespacho != null) { cmd.Parameters.Add(new OracleParameter(":FRETEREDESPACHO", modelo.freteredespacho));}
            if (modelo.codfornecfrete != null) { cmd.Parameters.Add(new OracleParameter(":CODFORNECFRETE", modelo.codfornecfrete));}
            if (modelo.codfornecredespacho != null) { cmd.Parameters.Add(new OracleParameter(":CODFORNECREDESPACHO", modelo.codfornecredespacho));}
            if (modelo.tipocarga != null) { cmd.Parameters.Add(new OracleParameter(":TIPOCARGA", modelo.tipocarga));}
            if (modelo.prazo1 != null) { cmd.Parameters.Add(new OracleParameter(":PRAZO1", modelo.prazo1));}
            if (modelo.prazo2 != null) { cmd.Parameters.Add(new OracleParameter(":PRAZO2", modelo.prazo2));}
            if (modelo.prazo3 != null) { cmd.Parameters.Add(new OracleParameter(":PRAZO3", modelo.prazo3));}
            if (modelo.prazo4 != null) { cmd.Parameters.Add(new OracleParameter(":PRAZO4", modelo.prazo4));}
            if (modelo.prazo5 != null) { cmd.Parameters.Add(new OracleParameter(":PRAZO5", modelo.prazo5));}
            if (modelo.prazo6 != null) { cmd.Parameters.Add(new OracleParameter(":PRAZO6", modelo.prazo6));}
            if (modelo.prazo7 != null) { cmd.Parameters.Add(new OracleParameter(":PRAZO7", modelo.prazo7));}
            if (modelo.prazo8 != null) { cmd.Parameters.Add(new OracleParameter(":PRAZO8", modelo.prazo8));}
            if (modelo.prazo9 != null) { cmd.Parameters.Add(new OracleParameter(":PRAZO9", modelo.prazo9));}
            if (modelo.prazo10 != null) { cmd.Parameters.Add(new OracleParameter(":PRAZO10", modelo.prazo10));}
            if (modelo.prazo11 != null) { cmd.Parameters.Add(new OracleParameter(":PRAZO11", modelo.prazo11));}
            if (modelo.prazo12 != null) { cmd.Parameters.Add(new OracleParameter(":PRAZO12", modelo.prazo12));}
            if (modelo.prazomedio != null) { cmd.Parameters.Add(new OracleParameter(":PRAZOMEDIO", modelo.prazomedio));}
            if (modelo.obsentrega1 != null) { cmd.Parameters.Add(new OracleParameter(":OBSENTREGA1", modelo.obsentrega1));}
            if (modelo.obsentrega2 != null) { cmd.Parameters.Add(new OracleParameter(":OBSENTREGA2", modelo.obsentrega2));}
            if (modelo.obsentrega3 != null) { cmd.Parameters.Add(new OracleParameter(":OBSENTREGA3", modelo.obsentrega3));}
            if (modelo.tipoembalagem != null) { cmd.Parameters.Add(new OracleParameter(":TIPOEMBALAGEM", modelo.tipoembalagem));}
            if (modelo.codepto != null) { cmd.Parameters.Add(new OracleParameter(":CODEPTO", modelo.codepto));}
            if (modelo.campanha != null) { cmd.Parameters.Add(new OracleParameter(":CAMPANHA", modelo.campanha));}
            if (modelo.coddistrib != null) { cmd.Parameters.Add(new OracleParameter(":CODDISTRIB", modelo.coddistrib));}
            if (modelo.vlcustocont != null) { cmd.Parameters.Add(new OracleParameter(":VLCUSTOCONT", modelo.vlcustocont));}
            if (modelo.vlcustorep != null) { cmd.Parameters.Add(new OracleParameter(":VLCUSTOREP", modelo.vlcustorep));}
            if (modelo.numnotamanif != null) { cmd.Parameters.Add(new OracleParameter(":NUMNOTAMANIF", modelo.numnotamanif));}
            if (modelo.seriemanif != null) { cmd.Parameters.Add(new OracleParameter(":SERIEMANIF", modelo.seriemanif));}
            if (modelo.origemped != null) { cmd.Parameters.Add(new OracleParameter(":ORIGEMPED", modelo.origemped));}
            if (modelo.especiemanif != null) { cmd.Parameters.Add(new OracleParameter(":ESPECIEMANIF", modelo.especiemanif));}
            if (modelo.numpedentfut != null) { cmd.Parameters.Add(new OracleParameter(":NUMPEDENTFUT", modelo.numpedentfut));}
            if (modelo.codfilialnf != null) { cmd.Parameters.Add(new OracleParameter(":CODFILIALNF", modelo.codfilialnf));}
            if (modelo.numcarmanif != null) { cmd.Parameters.Add(new OracleParameter(":NUMCARMANIF", modelo.numcarmanif));}
            if (modelo.numorca != null) { cmd.Parameters.Add(new OracleParameter(":NUMORCA", modelo.numorca));}
            if (modelo.codcontrato != null) { cmd.Parameters.Add(new OracleParameter(":CODCONTRATO", modelo.codcontrato));}
            if (modelo.datapedcli != null) { cmd.Parameters.Add(new OracleParameter(":DATAPEDCLI", modelo.datapedcli));}
            if (modelo.numpedbnf != null) { cmd.Parameters.Add(new OracleParameter(":NUMPEDBNF", modelo.numpedbnf));}
            if (modelo.broker != null) { cmd.Parameters.Add(new OracleParameter(":BROKER", modelo.broker));}
            if (modelo.codestabelecimento != null) { cmd.Parameters.Add(new OracleParameter(":CODESTABELECIMENTO", modelo.codestabelecimento));}
            if (modelo.numtabela != null) { cmd.Parameters.Add(new OracleParameter(":NUMTABELA", modelo.numtabela));}
            if (modelo.motivoposicao != null) { cmd.Parameters.Add(new OracleParameter(":MOTIVOPOSICAO", modelo.motivoposicao));}
            if (modelo.dtagendaentrega != null) { cmd.Parameters.Add(new OracleParameter(":DTAGENDAENTREGA", modelo.dtagendaentrega));}
            if (modelo.tipooper != null) { cmd.Parameters.Add(new OracleParameter(":TIPOOPER", modelo.tipooper));}
            if (modelo.codmotbloqueio != null) { cmd.Parameters.Add(new OracleParameter(":CODMOTBLOQUEIO", modelo.codmotbloqueio));}
            if (modelo.serieecf != null) { cmd.Parameters.Add(new OracleParameter(":SERIEECF", modelo.serieecf));}
            if (modelo.numcupom != null) { cmd.Parameters.Add(new OracleParameter(":NUMCUPOM", modelo.numcupom));}
            if (modelo.codclirecebedor != null) { cmd.Parameters.Add(new OracleParameter(":CODCLIRECEBEDOR", modelo.codclirecebedor));}
            if (modelo.conciliaimportacao != null) { cmd.Parameters.Add(new OracleParameter(":CONCILIAIMPORTACAO", modelo.conciliaimportacao));}
            if (modelo.numregiao != null) { cmd.Parameters.Add(new OracleParameter(":NUMREGIAO", modelo.numregiao));}
            if (modelo.numnota != null) { cmd.Parameters.Add(new OracleParameter(":NUMNOTA", modelo.numnota));}
            if (modelo.perdescfin != null) { cmd.Parameters.Add(new OracleParameter(":PERDESCFIN", modelo.perdescfin));}
            if (modelo.restricaotransp != null) { cmd.Parameters.Add(new OracleParameter(":RESTRICAOTRANSP", modelo.restricaotransp));}
            if (modelo.geracp != null) { cmd.Parameters.Add(new OracleParameter(":GERACP", modelo.geracp));}
            if (modelo.usaintegracaowms != null) { cmd.Parameters.Add(new OracleParameter(":USAINTEGRACAOWMS", modelo.usaintegracaowms));}
            if (modelo.vendaassistida != null) { cmd.Parameters.Add(new OracleParameter(":VENDAASSISTIDA", modelo.vendaassistida));}
            if (modelo.codmotivo != null) { cmd.Parameters.Add(new OracleParameter(":CODMOTIVO", modelo.codmotivo));}
            if (modelo.log != null) { cmd.Parameters.Add(new OracleParameter(":LOG", modelo.log));}
            if (modelo.dtcalcfrete != null) { cmd.Parameters.Add(new OracleParameter(":DTCALCFRETE", modelo.dtcalcfrete));}
            if (modelo.codfunccalcfrete != null) { cmd.Parameters.Add(new OracleParameter(":CODFUNCCALCFRETE", modelo.codfunccalcfrete));}
            if (modelo.eancobranca != null) { cmd.Parameters.Add(new OracleParameter(":EANCOBRANCA", modelo.eancobranca));}
            if (modelo.eanentrega != null) { cmd.Parameters.Add(new OracleParameter(":EANENTREGA", modelo.eanentrega));}
            if (modelo.usacfopvendanatv10 != null) { cmd.Parameters.Add(new OracleParameter(":USACFOPVENDANATV10", modelo.usacfopvendanatv10));}
            if (modelo.tipoprioridadeentrega != null) { cmd.Parameters.Add(new OracleParameter(":TIPOPRIORIDADEENTREGA", modelo.tipoprioridadeentrega));}
            if (modelo.codusur2 != null) { cmd.Parameters.Add(new OracleParameter(":CODUSUR2", modelo.codusur2));}
            if (modelo.codusur3 != null) { cmd.Parameters.Add(new OracleParameter(":CODUSUR3", modelo.codusur3));}
            if (modelo.codusur4 != null) { cmd.Parameters.Add(new OracleParameter(":CODUSUR4", modelo.codusur4));}
            if (modelo.codclinf != null) { cmd.Parameters.Add(new OracleParameter(":CODCLINF", modelo.codclinf));}
            if (modelo.numpedtv1 != null) { cmd.Parameters.Add(new OracleParameter(":NUMPEDTV1", modelo.numpedtv1));}
            if (modelo.usadebcredrca != null) { cmd.Parameters.Add(new OracleParameter(":USADEBCREDRCA", modelo.usadebcredrca));}
            if (modelo.brinde != null) { cmd.Parameters.Add(new OracleParameter(":BRINDE", modelo.brinde));}
            if (modelo.bonificaltdebcredrca != null) { cmd.Parameters.Add(new OracleParameter(":BONIFICALTDEBCREDRCA", modelo.bonificaltdebcredrca));}
            if (modelo.trocaaltdebcredrca != null) { cmd.Parameters.Add(new OracleParameter(":TROCAALTDEBCREDRCA", modelo.trocaaltdebcredrca));}
            if (modelo.brokeraltdebcredrca != null) { cmd.Parameters.Add(new OracleParameter(":BROKERALTDEBCREDRCA", modelo.brokeraltdebcredrca));}
            if (modelo.crmaltdebcredrca != null) { cmd.Parameters.Add(new OracleParameter(":CRMALTDEBCREDRCA", modelo.crmaltdebcredrca));}
            if (modelo.tipomovccrca != null) { cmd.Parameters.Add(new OracleParameter(":TIPOMOVCCRCA", modelo.tipomovccrca));}
            if (modelo.usacredrca != null) { cmd.Parameters.Add(new OracleParameter(":USACREDRCA", modelo.usacredrca));}
            if (modelo.gerardadosnfpaulista != null) { cmd.Parameters.Add(new OracleParameter(":GERARDADOSNFPAULISTA", modelo.gerardadosnfpaulista));}
            if (modelo.usasaldocontacorrentedescfin != null) { cmd.Parameters.Add(new OracleParameter(":USASALDOCONTACORRENTEDESCFIN", modelo.usasaldocontacorrentedescfin));}
            if (modelo.valordescfin != null) { cmd.Parameters.Add(new OracleParameter(":VALORDESCFIN", modelo.valordescfin));}
            if (modelo.codvisita != null) { cmd.Parameters.Add(new OracleParameter(":CODVISITA", modelo.codvisita));}
            if (modelo.codatendimento != null) { cmd.Parameters.Add(new OracleParameter(":CODATENDIMENTO", modelo.codatendimento));}
            if (modelo.vendatriangular != null) { cmd.Parameters.Add(new OracleParameter(":VENDATRIANGULAR", modelo.vendatriangular));}
            if (modelo.vlentrada != null) { cmd.Parameters.Add(new OracleParameter(":VLENTRADA", modelo.vlentrada));}
            if (modelo.ufdesembaraco != null) { cmd.Parameters.Add(new OracleParameter(":UFDESEMBARACO", modelo.ufdesembaraco));}
            if (modelo.localdesembaraco != null) { cmd.Parameters.Add(new OracleParameter(":LOCALDESEMBARACO", modelo.localdesembaraco));}
            if (modelo.custobonificacao != null) { cmd.Parameters.Add(new OracleParameter(":CUSTOBONIFICACAO", modelo.custobonificacao));}
            if (modelo.codfornecbonific != null) { cmd.Parameters.Add(new OracleParameter(":CODFORNECBONIFIC", modelo.codfornecbonific));}
            if (modelo.codbnf != null) { cmd.Parameters.Add(new OracleParameter(":CODBNF", modelo.codbnf));}
            if (modelo.tipodocumento != null) { cmd.Parameters.Add(new OracleParameter(":TIPODOCUMENTO", modelo.tipodocumento));}
            if (modelo.cfopbnfdegusta != null) { cmd.Parameters.Add(new OracleParameter(":CFOPBNFDEGUSTA", modelo.cfopbnfdegusta));}
            if (modelo.contaordem != null) { cmd.Parameters.Add(new OracleParameter(":CONTAORDEM", modelo.contaordem));}
            if (modelo.dataempenho != null) { cmd.Parameters.Add(new OracleParameter(":DATAEMPENHO", modelo.dataempenho));}
            if (modelo.numempenho != null) { cmd.Parameters.Add(new OracleParameter(":NUMEMPENHO", modelo.numempenho));}
            if (modelo.codunidadeexecutora != null) { cmd.Parameters.Add(new OracleParameter(":CODUNIDADEEXECUTORA", modelo.codunidadeexecutora));}
            if (modelo.placaveiculo != null) { cmd.Parameters.Add(new OracleParameter(":PLACAVEICULO", modelo.placaveiculo));}
            if (modelo.dtlimitefat != null) { cmd.Parameters.Add(new OracleParameter(":DTLIMITEFAT", modelo.dtlimitefat));}
            if (modelo.reservaestoquetv7 != null) { cmd.Parameters.Add(new OracleParameter(":RESERVAESTOQUETV7", modelo.reservaestoquetv7));}
            if (modelo.fornecentrega != null) { cmd.Parameters.Add(new OracleParameter(":FORNECENTREGA", modelo.fornecentrega));}
            if (modelo.codclitv8 != null) { cmd.Parameters.Add(new OracleParameter(":CODCLITV8", modelo.codclitv8));}
            if (modelo.ufveiculo != null) { cmd.Parameters.Add(new OracleParameter(":UFVEICULO", modelo.ufveiculo));}
            if (modelo.motoristaveiculo != null) { cmd.Parameters.Add(new OracleParameter(":MOTORISTAVEICULO", modelo.motoristaveiculo));}
            if (modelo.dtiniciodigitacaopedido != null) { cmd.Parameters.Add(new OracleParameter(":DTINICIODIGITACAOPEDIDO", modelo.dtiniciodigitacaopedido));}
            if (modelo.dtfimdigitacaopedido != null) { cmd.Parameters.Add(new OracleParameter(":DTFIMDIGITACAOPEDIDO", modelo.dtfimdigitacaopedido));}
            if (modelo.vldescabatimento != null) { cmd.Parameters.Add(new OracleParameter(":VLDESCABATIMENTO", modelo.vldescabatimento));}
            if (modelo.agrupamento != null) { cmd.Parameters.Add(new OracleParameter(":AGRUPAMENTO", modelo.agrupamento));}
            if (modelo.vendaexportacao != null) { cmd.Parameters.Add(new OracleParameter(":VENDAEXPORTACAO", modelo.vendaexportacao));}
            if (modelo.turnoentrega != null) { cmd.Parameters.Add(new OracleParameter(":TURNOENTREGA", modelo.turnoentrega));}
            if (modelo.numtransvendatv13 != null) { cmd.Parameters.Add(new OracleParameter(":NUMTRANSVENDATV13", modelo.numtransvendatv13));}
            if (modelo.codendentcli != null) { cmd.Parameters.Add(new OracleParameter(":CODENDENTCLI", modelo.codendentcli));}
            if (modelo.utilizavendaporembalagem != null) { cmd.Parameters.Add(new OracleParameter(":UTILIZAVENDAPOREMBALAGEM", modelo.utilizavendaporembalagem));}
            if (modelo.codcontato != null) { cmd.Parameters.Add(new OracleParameter(":CODCONTATO", modelo.codcontato));}
            if (modelo.numregexp != null) { cmd.Parameters.Add(new OracleParameter(":NUMREGEXP", modelo.numregexp));}
            if (modelo.numchaveexp != null) { cmd.Parameters.Add(new OracleParameter(":NUMCHAVEEXP", modelo.numchaveexp));}
            if (modelo.numdrawback != null) { cmd.Parameters.Add(new OracleParameter(":NUMDRAWBACK", modelo.numdrawback));}
            if (modelo.dtnftransf != null) { cmd.Parameters.Add(new OracleParameter(":DTNFTRANSF", modelo.dtnftransf));}
            if (modelo.rotinalanc != null) { cmd.Parameters.Add(new OracleParameter(":ROTINALANC", modelo.rotinalanc));}
            if (modelo.numpedorigem != null) { cmd.Parameters.Add(new OracleParameter(":NUMPEDORIGEM", modelo.numpedorigem));}
            if (modelo.pedduplicado != null) { cmd.Parameters.Add(new OracleParameter(":PEDDUPLICADO", modelo.pedduplicado));}
            if (modelo.vlbonific != null) { cmd.Parameters.Add(new OracleParameter(":VLBONIFIC", modelo.vlbonific));}
            if (modelo.vendalocestrang != null) { cmd.Parameters.Add(new OracleParameter(":VENDALOCESTRANG", modelo.vendalocestrang));}
            if (modelo.copiaidenticapeddup != null) { cmd.Parameters.Add(new OracleParameter(":COPIAIDENTICAPEDDUP", modelo.copiaidenticapeddup));}
            if (modelo.assinatura != null) { cmd.Parameters.Add(new OracleParameter(":ASSINATURA", modelo.assinatura));}
            if (modelo.condfinanc != null) { cmd.Parameters.Add(new OracleParameter(":CONDFINANC", modelo.condfinanc));}
            if (modelo.planosuppli != null) { cmd.Parameters.Add(new OracleParameter(":PLANOSUPPLI", modelo.planosuppli));}
            if (modelo.pagchequemoradia != null) { cmd.Parameters.Add(new OracleParameter(":PAGCHEQUEMORADIA", modelo.pagchequemoradia));}
            cmd.Parameters.Add(new OracleParameter(":NUMVOLUME", modelo.numvolume));
            conexao.Conectar();
            cmd.ExecuteNonQuery();
        ...
        public void Alterar(ModeloPCPEDC modelo)
        {
            ...
            if (modelo.numped != null) { cmd.Parameters.Add(new OracleParameter(":OLD_NUMPED", modelo.numped));}
            if (modelo.numped != null) { cmd.Parameters.Add(new OracleParameter(":NUMPED", modelo.numped));}
            if (modelo.data != null) { cmd.Parameters.Add(new OracleParameter(":DATA", modelo.data));}
            if (modelo.codusur != null) { cmd.Parameters.Add(new OracleParameter(":CODUSUR", modelo.codusur));}
            if (modelo.codcli != null) { cmd.Parameters.Add(new OracleParameter(":CODCLI", modelo.codcli));}
            if (modelo.numitens != null) { cmd.Parameters.Add(new OracleParameter(":NUMITENS", modelo.numitens));}
            if (modelo.vlatend != null) { cmd.Parameters.Add(new OracleParameter(":VLATEND", modelo.vlatend));}
        ...
        public void AlterarPC(ModeloPCPEDC modelo)
        {
            ...
            cmd.Parameters.Add(new OracleParameter(":NUMPED", modelo.numped));
            cmd.Parameters.Add(new OracleParameter(":VLTOTAL", modelo.vltotal));
            cmd.Parameters.Add(new OracleParameter(":VLTABELA", modelo.vltotal));
            ...
            cmd.Parameters.Add(new OracleParameter(":VLATEND", modelo.vlatend));
        ...
        public void Revert1(ModeloPCPEDC modelo)
        {
            try
            {
                ...
                cmd.CommandText = comando1;
                cmd.CommandType = System.Data.CommandType.Text;
                cmd.Parameters.Add(new OracleParameter(":NUMPED", Convert.ToInt64(modelo.numped)));
                conexao.Conectar();
                cmd.ExecuteNonQuery();
                conexao.Desconectar();
            }
