    ...
    public class DALUnidadeDeMedida
    {
        ...
        public void Incluir(ModeloUnidadeDeMedida modelo)
        {
            try
            {
                ...
                cmd.CommandText = "insert into undmedida(umed_sigla,umed_nome) values (@sigla,@nome); select @@IDENTITY;";
                cmd.Parameters.AddWithValue("@sigla", modelo.UmedNome);
        ...
        public ModeloUnidadeDeMedida CarregaModeloUnidadeDeMedida(int codigo)
        {
            ...
            if (registro.HasRows)
            {
                ...
                modelo.UmedSigla= Convert.ToString(registro["umed_sigla"]);
