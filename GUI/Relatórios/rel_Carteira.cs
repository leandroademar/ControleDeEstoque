...
namespace GUI.Relatórios {
    ...
    public class rel_Carteira : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "GUI.Relatórios.rel_Carteira.RPT";
            }
            set {
                // Do nothing
            }
    ...
    public class Cachedrel_Carteira : Component, ICachedReport {
        
        public Cachedrel_Carteira() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rel_Carteira rpt = new rel_Carteira();
            rpt.Site = this.Site;
            return rpt;
        }
